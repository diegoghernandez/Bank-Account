...
export const DividerField = ({ label, modalUtils }) => {
   ...
   return (
      <>
         <button 
            className="transition w-full h-12 p-4 inline-flex flex-row items-center justify-between outline-none border-b text-onSurface border-outline-variant focus:bg-onSurface/12 hover:bg-onSurface/8

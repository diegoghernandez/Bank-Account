...
export const TextField = ({
   ...
   return (
      <div className="inline-flex flex-col">
         <label htmlFor={forWhat} className={`max-w-[calc(100%-24px)] block absolute z-10 top-0 left-0 origin-top-left font-sans font-normal text-base cursor-text
         ...
         ${isClicked ? "outline-2 outline-primary"  : "outline-1 outline-outline hover:outline-onSurface"}`}>
            ...
            <input 
               ...
               ref={ref}
               value={value}
               className={`w-full h-14 p-4 outline-none text-onSurface`}
            ...
            {(type === TextFieldTypes.Menu && !isClicked) && <div className="flex justify-center items-center w-6 h-6 mr-3">
         ...
         <p className="ml-4 mt-1 text-onSurface-variant text-sm">Supporting text</p>
      </div>
   )
}

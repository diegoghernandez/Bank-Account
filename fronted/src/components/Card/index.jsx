...
export const Card = ({
   ...
   const figureColors = (isDisable) ? ["bg-surface-container-highest outline outline-2 outline-outline dark:bg-surface-container-highest dark:outline-outline-dark"
